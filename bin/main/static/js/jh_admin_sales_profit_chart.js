        ...
        function drawTable() {
		    ...
		    Object.values(admin_sales_profit_results).forEach(entry => {
			...
			var comboChart = new google.visualization.ColumnChart(document.getElementById('admin_sales_profit_chart_div'));
